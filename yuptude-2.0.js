...
var ytw = ce("aside", document.body, "ytw");
ytw.setAttribute("aria-label", "Yuptude");
//Minified contents of the yuptude css & html files
var yts = ce("style", ytw, "yptd-style");
yts.textContent = '#yptd button,#yptd-box{float:left;padding:0 .5em;display:block}#yptd button em,#yptd-bottom,#yptd-in{vertical-align:middle}#yptd-pit,#yptd-pit input{float:right}#yptd a,#yptd-bar{background-color:#fd0d5d}#yptd{z-index:9999999999;position:fixed;bottom:0;left:6px;font:16px Helvetica,Arial,sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%}#yptd *{margin:0}#yptd a{border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;float:left;margin:0 .5em 0 0;padding:.25em 1em;font-weight:700;color:#FFF}#yptd a em{font-size:.9em}#yptd a:active,#yptd a:focus,#yptd a:hover{outline:0;color:#fd0d5d;background-color:#FFF;text-decoration:none}#yptd button{border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;margin:.5em;width:2.5em;border-bottom:2px solid rgba(0,0,0,.25);text-decoration:none;color:#000;background-color:#FFF;cursor:pointer;text-align:center}#yptd button em{font-size:.75em}#yptd button:active,#yptd button:focus,#yptd button:hover{color:#fd0d5d}#yptd-bar{border-radius:3px 3px 0 0;-moz-border-radius:3px 3px 0 0;-webkit-border-radius:3px 3px 0 0;height:2.25em}#yptd-bar:after,#yptd-bottom:after{content:"";display:block;clear:both}#yptd-controls{float:right;height:2.25em;border-left:2px solid rgba(0,0,0,.33)}#yptd-box{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;width:4em;min-width:4em;height:100%;background-color:rgba(0,0,0,.15)}#yptd-in{width:100%;height:100%;border:0;text-align:center;font:14px Helvetica,Arial,sans-serif;font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#FFF;background-color:transparent}#yptd-bottom{padding:.75em;font-size:.75em;background-color:rgba(0,0,0,.8)}#yptd-pit{position:relative;padding:.25em 0}#yptd-pit label{margin-right:.5em;color:#FFF}#yptd-pit em{display:none}#yptd-pit:active em,#yptd-pit:focus em,#yptd-pit:hover em{display:block;position:absolute;top:-2.5em;left:0;padding:.5em;white-space:pre;font-size:.8em;background-color:#fd0d5d}#yptd-off,#yptd-lnk,#yptd_brwsrs{font-weight:strong;}#yptd button{background-color:white;border:none;}';
	let yptd=ce("div",ytw, "yptd");
	let yptd_bar=ce("div",yptd, "yptd-bar");
	let yptd_off=ce("button",yptd_bar, "yptd-off");
	let yptd_off_txt=ce("em",yptd_off);
	yptd_off_txt.textContent="Off";
	let yptd_controls=ce("div",yptd_bar, "yptd-controls");
	let yptd_dwn=ce("button",yptd_controls, "yptd-dwn");
	yptd_dwn.textContent="-";
	yptd_dwn.setAttribute("aria-label", "minus");
	let yptd_box=ce("div",yptd_controls, "yptd-box");
	yptd_box.setAttribute("aria-live","polite");
	let yptd_in=ce("input",yptd_box, "yptd-in");
	yptd_in.type="text";
	yptd_in.value=+s;
	yptd_in.setAttribute("aria-label", "Speed");
	let yptd_up=ce("button",yptd_controls, "yptd-up");
	yptd_up.textContent="+";
